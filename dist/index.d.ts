...
export declare namespace html {
    ...
    var attr: <K extends HTMLElement>(target: K, props: Partial<ExcludeFunc<{ [K_1 in WritableKeysOf<K>]: K[K_1]; }>>) => K;
...
export declare namespace svg {
    ...
    var attr: <K extends SVGElement>(target: K, props: Partial<ExcludeFunc<{ [K_1 in WritableKeysOf<K>]: K[K_1]; }>>) => K;
    var append: typeof import(".").append;
