...
export declare namespace html {
    ...
    var append: <K extends HTMLElement>(target: K, children: (HTMLElement | SVGSVGElement)[], insertFirst?: boolean) => K;
...
export declare namespace svg {
    ...
    var append: <K extends SVGElement>(target: K, children: SVGElement[], insertFirst?: boolean) => K;
